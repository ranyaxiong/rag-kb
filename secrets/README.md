...
```bash
# 创建密钥文件
echo "your-api-key-here" > secrets/openai_api_key/deepseek_api_key

# 设置环境变量指向文件
export OPENAI_API_KEY_FILE="./secrets/openai_api_key/deepseek_api_key"
```
...
# 方式2: 密钥文件
echo "sk-your-key" > secrets/openai_api_key/deepseek_api_key
export OPENAI_API_KEY_FILE="./secrets/openai_api_key/deepseek_api_key"
./scripts/start.sh
```
